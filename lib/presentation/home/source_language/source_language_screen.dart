...
class SourceLanguageScreen extends StatefulWidget {
  const SourceLanguageScreen({super.key});
...
class _SourceLanguageScreenState extends State<SourceLanguageScreen> {
  ...
  late SourceLanguageController _translateFromController;
              ...
              Expanded(
                child: ScrollConfiguration(
                  ...
                  child: ListView.builder(
                    itemCount:
                        _translateFromController.getAppLanguageList().length,
                    itemBuilder: (context, index) {
                      return Obx(
                        () {
                          return LanguageSelectionWidget(
                            title: _translateFromController
                                .getAppLanguageList()[index]
                                .title,
                            subTitle: _translateFromController
                                .getAppLanguageList()[index]
                                .subTitle,
                            imageUrl: _translateFromController
                                .getAppLanguageList()[index]
                                .image,
                            onItemTap: () async {
                              _translationController.sourceLanguage.value =
                                  _translateFromController
                                      .getAppLanguageList()[index];
                              _translateFromController
